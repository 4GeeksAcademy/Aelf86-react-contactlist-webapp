...
export const FormContact = () => {
  ...
  <div class="mb-3">
    ...
    <input value={phone} onChange={(e) => setPhone(e.target.value)}type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
  ...
  <button onClick={(e) => addContact(e)} className="btn btn-primary">Submit</button>
</form>
	</div>
	)
}